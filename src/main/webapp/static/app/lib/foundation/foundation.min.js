...
(function (e, t, n, r) {
    ...
    var r = /\+/g, o = e.cookie = function (r, u, a) {
        if (u !== n) {
            ...
            return u = o.json ? JSON.stringify(u) : String(u), t.cookie = [encodeURIComponent(r), "=", o.raw ? u : encodeURIComponent(u), a.expires ? "; expires=" + a.expires.toUTCString() : "", a.path ? "; path=" + a.path : "", a.domain ? "; io.jrocket.domain=" + a.domain : "", a.secure ? "; secure" : ""].join("")
        }
